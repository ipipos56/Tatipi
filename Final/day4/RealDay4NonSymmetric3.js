...
var main = function()
{
	...
	if(bortnum==0)
	{
		...
		while(robo_goriz==false)
		{
			...
			{
				valSen();
				curent_orient=[sz[0],sz[1],sz[2],0];
				sensInd=0;
    ...
    brick.display().addLabel("(" + (xpos - minx) + "," + (ypos - miny) + ")",1,1) //вывод ответа
    brick.display().redraw()
    script.wait(15000)
	}
    return 0;
