...
function _1to0()
{
	...
	while(flag==1)
	{
		...
		if(s[0].read()>18&&s[2].read()>18)
		{
			...
			ML(sp + mot);
			lerr = err;
			if((610-Math.floor((trueLeft+trueRight)/2))<=0)
			{
				stop();
				valSen()
				//print(sz[0]+" "+sz[1]+" "+sz[2]);
